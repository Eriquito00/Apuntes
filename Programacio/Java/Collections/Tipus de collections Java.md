...
- Deque (pila): es por implementar LinkedList i basicament s'implementen elements al final i es treuen els elements desde el principi.
- Queue (cua): tambe es pot implementar LinkedList i basicament d'afegeixen elements al final i es treuen elements del final.
